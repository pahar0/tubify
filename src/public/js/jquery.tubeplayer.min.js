...
;(function (e) {
    ...
    ;(e.tubeplayer = { TubePlayer: o }),
        (e.tubeplayer.defaults = {
            ...
            rateChange: function (t) {
                ...
                return function (r) {
                    var n = e('#' + t).parent()
                    return 'object' == typeof r && (r = r.data), a.onRateChange[t].call(n, r)
                }
            },
            onQualityChange: {},
            onRateChange: {},
        ...
        (e.fn.tubeplayer = function (t, r) {
            var n = e(this),
                l = typeof t
            return 0 === arguments.length || 'object' === l
                ? n.each(function () {
                      if (((n = e(this)), 'IFRAME' == n.prop('tagName'))) {
                          var a = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/,
                              r = n.attr('src').match(a)
                          if (r && 11 == r[7].length) {
                              var l = { initialVideo: r[7] },
                                  i = n.attr('class'),
                                  u = n.attr('id')
                              n.attr('width') && (l.width = n.attr('width')),
                                  n.attr('height') && (l.height = n.attr('height')),
                                  (l.allowFullScreen = void 0 !== n.attr('allowfullscreen') ? 'true' : !1)
                              var d = e('<div></div>').attr({ class: i ? i : '', id: u ? u : '' })
                              n.replaceWith(d)
                              var y = e.extend({}, e.tubeplayer.defaults.settings, l, t)
                              o.init(d, y)
                          }
                      } else o.init(e(this), t)
                  })
                : 'string' === l
                ? n.triggerHandler(t + a, r !== void 0 ? r : null)
                : void 0
        })
    var l = function (e) {
        return function (t, a) {
    ...
    ;(e.tubeplayer.getPlayers = function () {
        ...
        (o.init = function (l, u) {
            if (l.hasClass(r)) return l
            var d = e.extend({}, e.tubeplayer.defaults.settings, u)
            ;(d.playerID += '-' + t()), l.addClass(r).data(n, d)
            for (var y in i) l.bind(y + a, l, i[y])
        ...
        (o.getPkg = function (e) {
            ...
            return { $player: t, opts: a, ytplayer: r }
        }),
                    ...
                    new YT.Player(t.playerID, {
                        ...
                        events: {
                            onReady: function (a) {
                                ...
                                n.tubeplayer('opts').onPlayerLoaded.call(n), e.tubeplayer.defaults.afterReady(n)
                            },
        ...
        (o.initDefaults = function (e, t) {
            var a = t.playerID,
                r = e.onPlayer
            ;(r.unstarted[a] = t.onPlayerUnstarted),
                (r.ended[a] = t.onPlayerEnded),
                (r.playing[a] = t.onPlayerPlaying),
                (r.paused[a] = t.onPlayerPaused),
                (r.buffering[a] = t.onPlayerBuffering),
                (r.cued[a] = t.onPlayerCued),
                (r.loaded[a] = t.onPlayerLoaded),
                (e.onQualityChange[a] = t.onQualityChange),
                (e.onRateChange[a] = t.onRateChange)
            var n = e.onErr
            ;(n.defaultError[a] = t.onError),
                (n.notFound[a] = t.onErrorNotFound),
                (n.notEmbeddable[a] = t.onErrorNotEmbeddable),
                (n.invalidParameter[a] = t.onErrorInvalidParameter)
        }),
    ...
    var i = {
        ...
        play: l(function (e, t, a) {
            var r, n
            'object' == typeof t ? ((r = t.id), (n = t.time)) : t !== void 0 && ((r = t), (n = 0)),
                r ? a.ytplayer.loadVideoById({ videoId: r, startSeconds: n, suggestedQuality: a.opts.preferredQuality }) : a.ytplayer.playVideo(),
                a.opts.onPlay(t)
        }),
        playPlaylist: l(function (e, t, a) {
            var r, n, o
            if ('object' == typeof t) {
                var l = void 0 !== t.length
                ;(r = l ? t : t.playlist), (o = l ? 0 : t.time || 0), (n = l ? 0 : t.index || 0)
            } else t !== void 0 && ((r = t), (o = 0), (n = 0))
            r && (a.ytplayer.loadPlaylist(r, n, o, a.opts.preferredQuality), a.opts.onPlay(t))
        }),
        ...
        data: l(function (e, t, a) {
            var r = {},
                n = a.ytplayer
            return (
                (r.videoLoadedFraction = n.getVideoLoadedFraction()),
                (r.bytesLoaded = n.getVideoBytesLoaded()),
                (r.bytesTotal = n.getVideoBytesTotal()),
                (r.startBytes = n.getVideoStartBytes()),
                (r.state = n.getPlayerState()),
                (r.currentTime = n.getCurrentTime()),
                (r.duration = n.getDuration()),
                (r.videoURL = n.getVideoUrl()),
                (r.playlist = { videoIDs: n.getPlaylist(), currentIndex: n.getPlaylistIndex() }),
                (r.videoEmbedCode = n.getVideoEmbedCode()),
                (r.videoID = o.getVideoIDFromURL(r.videoURL)),
                (r.availableQualityLevels = n.getAvailableQualityLevels()),
                (r.availablePlaybackRates = n.getAvailablePlaybackRates()),
                r
            )
        }),
        ...
        destroy: l(function (t, l, i) {
            ...
            var u = e.tubeplayer.defaults,
                d = ['unstarted', 'ended', 'playing', 'paused', 'buffering', 'cued', 'loaded']
            return (
                e.each(d, function (e, t) {
                    delete u.onPlayer[t][i.opts.playerID]
                }),
                (d = ['defaultError', 'notFound', 'notEmbeddable', 'invalidParameter']),
                e.each(d, function (e, t) {
                    delete u.onErr[t][i.opts.playerID]
                }),
                delete u.onQualityChange[i.opts.playerID],
                delete u.onRateChange[i.opts.playerID],
                'destroy' in i.ytplayer && i.ytplayer.destroy(),
                e(i.ytplayer).remove(),
                null
            )
        }),
