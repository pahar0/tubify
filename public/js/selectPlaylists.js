...
function secondsToString(e) {
    const h = Math.floor(e / 3600).toString().padStart(1, '0'),
        ...
        s = Math.floor(e % 60).toString().padStart(1, '0');
    return (h == 0 ? '' : h + ' ' + pluralize(h, 'hour') + ' ') + (m == 0 ? '' : m + ' ' + pluralize(m, 'minute') + ' ') + (s == 0 ? '' : s + ' ' + pluralize(s, 'second') + ' ')
}
...
$(document).ready(function (e) {
    ...
    $('.convert').click(function () {
        ...
        const playlists = $('.selected').map(function (i, v) {
